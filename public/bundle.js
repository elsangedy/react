...
/***/ function(module, exports, __webpack_require__) {
	...
	var base = _reBase2['default'].createClass('https://munir7-react.firebaseio.com/');
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'col-md-4' },
	          _react2['default'].createElement(_NotesNotes2['default'], { username: username, notes: this.state.notes, noteAdd: this.handleNoteAdd.bind(this) })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NoteAdd = __webpack_require__(203);
	  ...
	  _createClass(Notes, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_NoteAdd2['default'], { username: this.props.username, noteAdd: this.props.noteAdd }),
	...
	Notes.propTypes = {
	  ...
	  noteAdd: _react2['default'].PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoteAdd = (function (_React$Component) {
	  function NoteAdd() {
	    _classCallCheck(this, NoteAdd);

	    _get(Object.getPrototypeOf(NoteAdd.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _inherits(NoteAdd, _React$Component);
